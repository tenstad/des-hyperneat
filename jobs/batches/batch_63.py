...
def run():
    ...
    param_grid = {
        ...
        'DATASET': ['datasets/generated/iris', 'datasets/generated/wine', 'datasets/generated/retina'],
        'HIDDEN_ACTIVATION': ['Sigmoid', 'ReLU', 'None'],
    }
    ...
    des_params = {
        ...
        'HIDDEN_ACTIVATIONS': 'None Linear Step ReLU Sigmoid Tanh Gaussian OffsetGaussian Sine Square',
        'OUTPUT_ACTIVATIONS': 'None Linear Step ReLU Sigmoid Tanh Gaussian OffsetGaussian Sine Square',
    }
